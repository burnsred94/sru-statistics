...
export class KeywordsContextService {
    ...
    constructor(
        @Inject(STRATEGY_REFRESH.KEYWORDS_DATA_REFRESH) @Optional() private keywordsDataRefresh: KeywordsDataContextStrategy,
        @Inject(STRATEGY_REFRESH.KEYWORDS_NIGHT_REFRESH) @Optional() private keywordsNightRefresh: KeywordsNightRefresh,
    ) {
